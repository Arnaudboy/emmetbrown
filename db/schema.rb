...
ActiveRecord::Schema.define(version: 2019_08_01_145613) do
  ...
  create_table "doctor_speciality", id: false, force: :cascade do |t|
  ...
  create_table "join_tables", force: :cascade do |t|
    ...
    t.index ["speciality_id"], name: "index_join_tables_on_speciality_id"
  end
